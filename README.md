...
**02/21/2020**
Set up firebase collections in database. Was able to add classes, goals, and other facts. Tried fixing the automatic update, but ran into more problems. Finally found the problem, with automatically updating the table.
